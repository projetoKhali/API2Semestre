module org.openjfx.api2semestre {
    ...
    opens org.openjfx.api2semestre.view.controllers.views.templates to javafx.fxml;
    opens org.openjfx.api2semestre.view.controllers.views.popups to javafx.fxml;
